...
/**
 * @author dave sinclair(david.sinclair@lisa-park.com) Modified by Alex Mylnikov
 * (alexmy@lisa-park.com) 2013-11-14
 */
...
//        OpenModelDialog.tpsw = tpsw;
    ...
    public JComponent createContentPanel() {
        ...
        modelNameTxt.addActionListener((ActionEvent e) -> {
        ...
        searchList.addListSelectionListener((ListSelectionEvent e) -> {
    ...
    /**
     * Uses the {@link #repository} to search for processing models that are
     * named like the specified searchCriteria.
     *
     ...
     * {@link org.lisapark.octopus.designer.OpenModelDialog} for opening a
     * {@link ProcessingModel}.
     *
