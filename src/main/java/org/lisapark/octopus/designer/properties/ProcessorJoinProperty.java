 ...
 * an Octopus {@link org.lisapark.koctopus.core.processor.ProcessorInput} in a {@link com.jidesoft.grid.PropertyTable}. 
 ...
 * with {@link org.lisapark.koctopus.core.event.Attribute}s from the {@link org.lisapark.octopus.core.processor.ProcessorInput#getSource()} if it is
...
class ProcessorJoinProperty extends ComponentProperty<ProcessorInput> {
     ...
     * there are no {@link org.lisapark.koctopus.core.event.Attribute}s to choose from.
     * todo update comment
     *
