...
public class DesignerApplication {
    ...
    private static final String[] REPO_PATH = {"file:///home/alexmy/.m2/repository/k-octopus/k-octopus-processors/0.7.4/k-octopus-processors-0.7.4-jar-with-dependencies.jar"};
